...
module "gcp_service_attachments" {
  ...
  rediscloud_service_attachments = rediscloud_private_service_connect_endpoint.endpoint[count.index].service_attachments
...
resource "rediscloud_private_service_connect_endpoint_accepter" "accepter" {
  ...
  subscription_id                     = var.rediscloud_subscription_id
  private_service_connect_service_id  = rediscloud_private_service_connect.service.private_service_connect_service_id
  private_service_connect_endpoint_id = rediscloud_private_service_connect_endpoint.endpoint[count.index].private_service_connect_endpoint_id
  action                              = "accept"
